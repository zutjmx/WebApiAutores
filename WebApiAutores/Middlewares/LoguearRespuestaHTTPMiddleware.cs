...
namespace WebApiAutores.Middlewares
{
    ...
    {
        public static IApplicationBuilder UseLoguearRespuestaHTTP(this IApplicationBuilder applicationBuilder)
        {
            return applicationBuilder.UseMiddleware<LoguearRespuestaHTTPMiddleware>();
        }
    }
